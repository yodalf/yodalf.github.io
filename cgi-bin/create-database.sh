...
sqlite3 database.db "CREATE TABLE users ( id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT NOT NULL UNIQUE, usercert TEXT, userkey TEXT, pwdhash TEXT, cert TEXT, role TEXT);"
...
chown lighttpd:lighttpd database.db
